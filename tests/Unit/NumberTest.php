...
describe(Number::class, function () {
    ...
    it('FormatWithDifferentLocale', function () {
    ...
    it('FormatWithAppLocale', function () {
        $this->assertSame('123,456,789', Number::format(123456789));
    ...
    it('RandomWithMinAndMax', function () {
        foreach (range(0, 100) as $i) {
